...
public class WorldShader extends Shader {
    ...
    private int ms_framebuffer_handel, ms_renderbuffer_handel, ms_color_texture, ms_glow_texture, ms_id_texture;
    private int framebuffer_handel, renderbuffer_handel, color_texture, bloom_texture, id_texture;
    ...
    public WorldShader() {
        ...
        glNamedFramebufferDrawBuffers(ms_framebuffer_handel, fboBuffers);
        ...
        glNamedFramebufferDrawBuffers(framebuffer_handel, fboBuffers2);
