...
public class MainMenuScene extends SagaScene implements KeyboardHandler {
    ...
    private UIImage<MainMenuScene>
            dust1_1, dust1_2, dust2_1, dust2_2, dust3_1, dust3_2,
            planet, ship;

    public MainMenuScene(SagaGame game) {
        super(game);
    ...
    protected void loadUI() {
        ...
        UIImage<MainMenuScene> background = new UIImage<>(this,
        ...
        // Window
        UIImage<MainMenuScene> stars = new UIImage<>(this, winWidth, winHeight,
