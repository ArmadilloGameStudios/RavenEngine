...
public class TextShader extends Shader {
    ...
    private int highlight_location, sprite_sheet_location, rect_location;
    ...
    public void write(Vector2i size, Vector2i src, Vector2i des, ShaderTexture srcImage, Highlight highlight) {
