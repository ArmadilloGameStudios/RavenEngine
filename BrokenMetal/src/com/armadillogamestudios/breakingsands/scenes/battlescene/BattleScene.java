...
import com.armadillogamestudios.breakingsands.character.Effect;
import com.armadillogamestudios.breakingsands.character.Weapon;
import com.armadillogamestudios.breakingsands.scenes.battlescene.ai.AI;
import com.armadillogamestudios.breakingsands.scenes.battlescene.decal.Wall;
import com.armadillogamestudios.breakingsands.scenes.battlescene.levelup.UILevelUp;
import com.armadillogamestudios.breakingsands.scenes.battlescene.map.Map;
import com.armadillogamestudios.breakingsands.scenes.battlescene.map.Terrain;
import com.armadillogamestudios.breakingsands.scenes.battlescene.menu.Menu;
import com.armadillogamestudios.breakingsands.scenes.battlescene.pawn.Hack;
import com.armadillogamestudios.breakingsands.scenes.battlescene.pawn.Pawn;
import com.armadillogamestudios.breakingsands.scenes.battlescene.pawn.PawnFactory;
import com.armadillogamestudios.engine2d.ui.container.UICenterContainer;
import com.armadillogamestudios.engine2d.ui.container.UIUpperContainer;
import com.armadillogamestudios.engine2d.ui.container.UIUpperLeftContainer;
import com.armadillogamestudios.engine2d.ui.container.UIUpperRightContainer;
...
import static com.armadillogamestudios.breakingsands.scenes.battlescene.BattleScene.State.*;
...
public class BattleScene extends Scene<BrokenMetalGame> implements GameDatable {
    ...
    private com.armadillogamestudios.breakingsands.scenes.battlescene.map.Map map;
    ...
    public void onEnterScene() {
        ...
        if (loadGameData != null) {
            ...
            // Terrain
            map = new com.armadillogamestudios.breakingsands.scenes.battlescene.map.Map(this, loadGameData.getData("map"));
            addChild(map);
...
//            difficulty = 50;
            ...
            // Terrain
            map = new com.armadillogamestudios.breakingsands.scenes.battlescene.map.Map(this, difficulty);
            map.generate();
            addChild(map);
        }
